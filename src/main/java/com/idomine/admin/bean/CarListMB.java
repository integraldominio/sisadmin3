package com.idomine.admin.bean;

import com.github.adminfaces.template.exception.BusinessException;
import com.idomine.admin.infra.model.Filter;
import com.idomine.admin.model.Car;
import com.idomine.admin.service.CarService;
...
import static com.idomine.admin.util.Utils.addDetailMessage;
    ...
    public void initDataModel() {
        cars = new LazyDataModel<Car>() {
            ...
            public List<Car> load(int first, int pageSize,
                ...
                com.idomine.admin.infra.model.SortOrder order = null;
                if (sortOrder != null) {
                    order = sortOrder.equals(SortOrder.ASCENDING) ? com.idomine.admin.infra.model.SortOrder.ASCENDING
                            : sortOrder.equals(SortOrder.DESCENDING) ? com.idomine.admin.infra.model.SortOrder.DESCENDING
                            : com.idomine.admin.infra.model.SortOrder.UNSORTED;
                }
